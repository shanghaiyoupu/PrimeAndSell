...
@interface XCDDViewController ()

@end

@implementation XCDDViewController
...
- (void)setAddView
{
    ...
    [button1 addTarget:self action:@selector(toothBtn:) forControlEvents:UIControlEventTouchUpInside];
    [button1 setTitle:@"蓝牙打印" forState:UIControlStateNormal];
    ...
    [button2 addTarget:self action:@selector(removeBtn:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setTitle:@"撤销" forState:UIControlStateNormal];
