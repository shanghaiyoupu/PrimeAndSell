...
- (void)viewDidLoad {
    ...
    [self setAddView];
    self.dataName = [[NSMutableArray alloc]initWithObjects:@"单号",@"制单人",@"出货仓库",@"业务日期", nil];
    self.dataText = [[NSMutableArray alloc]initWithObjects:@"DB123456789098765",@"小赵",@"总店门店",@"2015-12-23 07:45", nil];
