...
@interface KHQZViewController ()

@end

@implementation KHQZViewController
...
- (void)viewDidLoad {
    ...
    self.dataSection2 = [[NSMutableArray alloc]initWithObjects:@"初期客户欠款金额",@"客户累计欠款", nil];
    [self setAddView];
