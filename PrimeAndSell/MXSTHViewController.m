...
@interface MXSTHViewController ()

@end

@implementation MXSTHViewController
...
- (void)viewDidLoad {
    ...
    self.dataName = [[NSMutableArray alloc]initWithObjects:@"单号",@"制单人",@"调出仓库",@"退货仓库",@"业务日期", nil];
