...
@interface XGJZViewController ()

@end

@implementation XGJZViewController
...
- (void)viewDidLoad {
    ...
    self.dataSection2 = [[NSMutableArray alloc]initWithObjects:@"本次实付金额",@"客户累计欠供应商款", nil];
