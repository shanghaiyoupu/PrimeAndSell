...
@interface KHDJViewController ()

@end

@implementation KHDJViewController
...
- (void)viewDidLoad {
    ...
    self.dataSection2 = [[NSMutableArray alloc]initWithObjects:@"期初客户欠款金额",@"客户累计欠款", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 2) {
        ...
        cell.jiSuan.text = @"新增供应商或账款阶段性结算时初始化客户欠款";
        return cell;
    }
    return nil;
}
