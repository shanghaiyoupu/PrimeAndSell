...
- (void)viewDidLoad {
    ...
    NSString *filePath0 = [[NSBundle mainBundle]pathForResource:@"ckcxList1.plist" ofType:nil];
    NSDictionary *dic0 = [[NSDictionary alloc]initWithContentsOfFile:filePath0];
    for (int i = 0; i < dic0.count; i ++) {
        NSArray *array = [dic0 objectForKey:[NSString stringWithFormat:@"%d",i]];
        [self.dataName addObject:array];
    }
    NSString *filePath1 = [[NSBundle mainBundle]pathForResource:@"ckcxList2.plist" ofType:nil];
