...
@interface CGJHViewController ()

@end

@implementation CGJHViewController
...
- (void)viewDidLoad {
    ...
    [self setAddView];
    self.dataName = [[NSMutableArray alloc]initWithObjects:@"供应商",@"单号",@"制单人",@"进货仓库",@"业务日期", nil];
